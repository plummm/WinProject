...
namespace AutoBackup.Behaviors
{
    class ListBoxDragDropBehavior
    {
        ...
        private void OnDragOver(object sender, Telerik.Windows.DragDrop.DragEventArgs e)
        {
            ...
            //this.AssociatedObject.ItemsSource = (sender as FileInfo)
            Type itemsType = null;
            if (this.AssociatedObject.ItemsSource != null)
            {
                itemsType = (this.AssociatedObject.ItemsSource as IList).AsQueryable().ElementType;
            }
